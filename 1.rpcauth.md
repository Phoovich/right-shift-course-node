...
### 4. Check the status of bitcoind
...
### 5. Check the log file for any error
...
#### 6.2 test from your computer (For MacOS or Linux)
...
#### 2 test from your computer (For MacOS or Linux)

...
### 2.4 try to run bitcoin rpc explorer
...
<!-- TODO: add image when npm start and error -->

> [!NOTE]
> Control-C to stop the server

### 2.5 Configure BTC RPC explorer
...
<!-- TODO: try config auth only cookie -->
...
<!-- TODO: add image btc rpc explorer can use -->

### 2.9 add electrs server to BTC RPC btc-rpc-explorer
...
pi@raspberrypi:~ $ sudo systemctl status btc-rpc-explorer.service
...
### 3.2 restart tor service

```bash
$ sudo systemctl restart tor
```

### 3.3 get your .onion address
...
### 3.4 access BTC RPC Explorer via Tor
